...
export class TasksController {
  ...
  updateTaskSplitStatus(
    @Request() req,
    @Param('id') id: string,
    @Body() taskSplitUpdateDto: UpdateTaskSplitDto,
  ) {
    return this.tasksService.updateTaskSplitStatus(
      +id,
      taskSplitUpdateDto,
      req.user,
    );
  ...
  async updateTaskCategory(
    ...
    const user = req.user;
    return this.tasksService.updateTaskCategory(
      user,
      +id,
